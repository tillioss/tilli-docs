  ...
  return (
    <Layout
      ...
      <main>
        ...
        <button type="button" style={{backgroundColor: 'yellowgreen'}} ><a href="https://tilli.teqbahn.com/tilli-web" target="_blank"><h1>     Play     </h1></a></button>
        </div>
        ...
        <div style={{textAlign: "center"}}>
        <button type="button" style={{backgroundColor: 'yellowgreen'}} ><a href="https://github.com/tillioss/tilli-ide" target="_blank"><h1>   IDE     </h1></a></button>
        <button type="button" style={{backgroundColor: 'yellowgreen'}}><a href="https://github.com/tillioss/Godot-Strategies-V1" target="_blank"><h1>    Tilli x Godot     </h1></a></button>
        </div>
        ...
        <div style={{textAlign: "center"}}>
        <button type="button" style={{backgroundColor: 'yellowgreen'}} ><a href="https://tillioss.github.io/docs/project-charter/" target="_blank"><h1>Project Charter</h1></a></button>
        </div>
        ...
        <div style={{textAlign: "center" }}>
        <button type="button" style={{backgroundColor: 'yellowgreen'}} ><a href="https://github.com/tillioss" target="_blank"><h1> Github </h1></a></button>
        </div>
